...
(function(e, t, n, r) {
    ...
    var s = function(t, r) {
        ...
        var t = [];
        return e || t.push("data"), this.namespace.length > 0 && t.push(this.namespace), 
        t.push(this.name), t.join("-");
    }, u = function(e) {
        ...
        s(this.scope).is("[" + this.attr_name() + "]") ? (s(this.scope).data(this.attr_name(!0) + "-init", e.extend({}, this.settings, n || t, this.data_options(s(this.scope)))), 
        i && this.events(this.scope)) : s("[" + this.attr_name() + "]", this.scope).each(function() {
            var i = !s(this).data(r.attr_name(!0) + "-init");
            s(this).data(r.attr_name(!0) + "-init", e.extend({}, r.settings, n || t, r.data_options(s(this)))), 
            i && r.events(this);
        });
    }, f = function(e, t) {
        function n() {
    ...
    t.matchMedia = t.matchMedia || function(e) {
        ...
        return s.id = "mq-test-1", s.style.cssText = "position:absolute;top:-100em", i.style.background = "none", 
        i.appendChild(s), function(e) {
            return s.innerHTML = '&shy;<style media="' + e + '"> #mq-test-1 { width: 42px; }</style>', 
            n.insertBefore(i, r), t = s.offsetWidth === 42, n.removeChild(i), {
                matches: t,
                media: e
            };
        };
        ...
        init_lib: function(t, n) {
            return this.libs.hasOwnProperty(t) ? (this.patch(this.libs[t]), n && n.hasOwnProperty(t) ? (typeof this.libs[t].settings != "undefined" ? e.extend(!0, this.libs[t].settings, n[t]) : typeof this.libs[t].defaults != "undefined" && e.extend(!0, this.libs[t].defaults, n[t]), 
            this.libs[t].init.apply(this.libs[t], [ this.scope, n[t] ])) : (n = n instanceof Array ? n : new Array(n), 
            this.libs[t].init.apply(this.libs[t], n))) : function() {};
        },
        patch: function(e) {
            e.scope = this.scope, e.namespace = this.global.namespace, e.rtl = this.rtl, e.data_options = this.utils.data_options, 
            e.attr_name = o, e.add_namespace = u, e.bindings = a, e.S = this.utils.S;
        },
        ...
        utils: {
            ...
            data_options: function(t, n) {
                ...
                while (i--) s = o[i].split(":"), s = [ s[0], s.slice(1).join(":") ], /true/i.test(s[1]) && (s[1] = !0), 
                /false/i.test(s[1]) && (s[1] = !1), f(s[1]) && (s[1].indexOf(".") === -1 ? s[1] = parseInt(s[1], 10) : s[1] = parseFloat(s[1])), 
                s.length === 2 && s[0].length > 0 && (r[l(s[0])] = l(s[1]));
                return r;
            },
            register_media: function(t, n) {
                Foundation.media_queries[t] === r && (e("head").append('<meta class="' + n + '">'), 
    ...
    Foundation.libs.dropdown = {
        ...
        events: function(n) {
            ...
            i(this.scope).off(".dropdown").on("click.fndtn.dropdown", "[" + this.attr_name() + "]", function(t) {
                ...
                var t = i(this), n, s;
                clearTimeout(r.timeout), t.data(r.data_attr()) ? (n = i("#" + t.data(r.data_attr())), 
                s = t) : (n = t, s = i("[" + r.attr_name() + "='" + n.attr("id") + "']"));
        ...
        close: function(e) {
            var t = this;
            e.each(function() {
                t.S(this).hasClass(t.settings.active_class) && (t.S(this).css(Foundation.rtl ? "right" : "left", "-99999px").removeClass(t.settings.active_class).prev("[" + t.attr_name() + "]").removeClass(t.settings.active_class).removeData("target"), 
                t.S(this).trigger("closed", [ e ]));
            });
        },
        closeall: function() {
            var t = this;
        ...
        open: function(e, t) {
            this.css(e.addClass(this.settings.active_class), t), e.prev("[" + this.attr_name() + "]").addClass(this.settings.active_class), 
            e.data("target", t.get(0)).trigger("opened", [ e, t ]);
        },
        data_attr: function() {
        ...
        toggle: function(e) {
            ...
            this.close.call(this, this.S("[" + this.attr_name() + "-content]").not(t)), t.hasClass(this.settings.active_class) ? (this.close.call(this, t), 
            t.data("target") !== e.get(0) && this.open.call(this, t, e)) : this.open.call(this, t, e);
        },
        resize: function() {
        ...
        dirs: {
            ...
            top: function(e, t) {
                var n = Foundation.libs.dropdown, r = n.dirs._base.call(this, e), i = e.outerWidth() / 2 - 8;
                return this.addClass("drop-top"), (e.outerWidth() < this.outerWidth() || n.small()) && n.adjust_pip(i, r), 
                Foundation.rtl ? {
            ...
            bottom: function(e, t) {
                var n = Foundation.libs.dropdown, r = n.dirs._base.call(this, e), i = e.outerWidth() / 2 - 8;
                return (e.outerWidth() < this.outerWidth() || n.small()) && n.adjust_pip(i, r), 
                n.rtl ? {
                    left: r.left - this.outerWidth() + e.outerWidth(),
        ...
        adjust_pip: function(e, t) {
            ...
            n.insertRule ? (n.insertRule([ r, "{", s, "}" ].join(" "), this.rule_idx), n.insertRule([ i, "{", o, "}" ].join(" "), this.rule_idx + 1)) : (n.addRule(r, s, this.rule_idx), 
            n.addRule(i, o, this.rule_idx + 1));
        },
        clear_idx: function() {
        ...
        off: function() {
            ...
            this.S(t).off(".fndtn.dropdown"), this.S("[data-dropdown-content]").off(".fndtn.dropdown");
        },
        reflow: function() {}
    };
}(jQuery, window, window.document), function(e, t, n, r) {
    ...
    var i = function() {}, s = function(r, i) {
        ...
        s.cache = {}, s.slides = function() {
            ...
            i.slide_number && (l.find("span:first").text(parseInt(t) + 1), l.find("span:last").text(s.slides().length)), 
            i.bullets && (c.children().removeClass(i.bullets_active_class), e(c.children().get(t)).addClass(i.bullets_active_class));
            ...
            f.addClass(i.animation), i.stack_on_small && a.addClass(i.stack_on_small_class), 
            i.navigation_arrows && (a.append(e('<a href="#"><span></span></a>').addClass(i.prev_class)), 
            a.append(e('<a href="#"><span></span></a>').addClass(i.next_class))), i.timer && (h = e("<div>").addClass(i.timer_container_class), 
            h.append("<span>"), i.timer_show_progress_bar && h.append(e("<div>").addClass(i.timer_progress_class)), 
            h.addClass(i.timer_paused_class), a.append(h)), i.slide_number && (l = e("<div>").addClass(i.slide_number_class), 
            l.append("<span></span> " + i.slide_number_text + " <span></span>"), a.append(l)), 
            i.bullets && (c = e("<ol>").addClass(i.bullets_container_class), a.append(c), c.wrap('<div class="orbit-bullets-container"></div>'), 
            s.slides().each(function(t, n) {
                var r = e("<li>").attr("data-orbit-slide", t).on("click", s.link_bullet);
                c.append(r);
            }));
            ...
            if (r === !1) return !1;
            f.trigger("before-slide-change.fndtn.orbit"), i.before_slide_change(), p = e, u.css("transitionDuration", i.animation_speed + "ms"), 
            a.css("transitionDuration", i.animation_speed + "ms");
            var l = function() {
                var r = function() {
                    t === !0 && s.cache.timer.restart(), s.update_slide_number(p), a.removeClass("animate-in"), 
                    a.addClass(i.active_slide_class), s.update_active_link(e), f.trigger("after-slide-change.fndtn.orbit", [ {
                        slide_number: p,
            ...
            if (typeof n == "string" && (n = e.trim(n)) != "") if (isNaN(parseInt(n))) {
                var r = a.find("[data-orbit-slide=" + n + "]");
                r.index() != -1 && (n = r.index() + 1, s._prepare_direction(n), setTimeout(function() {
                    s._goto(n);
                }, 100));
            } else n = parseInt(n), s._prepare_direction(n), setTimeout(function() {
                s._goto(n);
            }, 100);
            ...
            e.hasClass(i.timer_paused_class) ? (typeof s.cache.timer == "undefined" && (s.cache.timer = s.create_timer()), 
            s.cache.timer.start()) : typeof s.cache.timer == "object" && s.cache.timer.stop();
        }, s.init = function() {
            s.build_markup(), i.timer && (s.cache.timer = s.create_timer(), Foundation.utils.image_loaded(this.slides().find("img"), s.cache.timer.start)), 
            d = new u(i, f);
            if (m) {
            ...
            a.on("click", "." + i.next_class, s.next), a.on("click", "." + i.prev_class, s.prev), 
            i.next_on_click && a.on("click", "." + i.slides_container_class + " [data-orbit-slide]", s.link_bullet), 
            a.on("click", s.toggle_timer), i.swipe && f.on("touchstart.fndtn.orbit", function(e) {
                if (s.cache.animating) return;
                e.touches || (e = e.originalEvent), e.preventDefault(), e.stopPropagation(), s.cache.start_page_x = e.touches[0].pageX, 
                s.cache.start_page_y = e.touches[0].pageY, s.cache.start_time = new Date().getTime(), 
                s.cache.delta_x = 0, s.cache.is_scrolling = null, s.cache.direction = null, s.stop_timer();
                ...
                requestAnimationFrame(function() {
                    ...
                    if (i.animation === "slide") {
                        var r, o;
                        r = s.cache.delta_x / a.width() * 100, r >= 0 ? o = -(100 - r) : o = 100 + r, s.cache.current.css("transform", "translate3d(" + r + "%,0,0)"), 
                        s.cache.next.css("transform", "translate3d(" + o + "%,0,0)");
                    }
                });
            ...
            Foundation.utils.image_loaded(l, s.compute_dimensions), Foundation.utils.image_loaded(l, function() {
                a.prev("." + i.preloader_class).css("display", "none"), s.update_slide_number(p), 
                s.update_active_link(p), f.trigger("ready.fndtn.orbit");
            });
        }, s.init();
    }, o = function(e, t, n) {
        ...
        this.update_progress = function(e) {
            ...
            clearTimeout(a), e.addClass(t.timer_paused_class), f = -1, o && r.update_progress(0), 
            r.start();
        }, this.start = function() {
            if (!e.hasClass(t.timer_paused_class)) return !0;
            f = f === -1 ? i : f, e.removeClass(t.timer_paused_class), o && (u = new Date().getTime(), 
            s.animate({
                width: "100%"
        ...
        this.next = function(r, i, s) {
            Modernizr.csstransitions ? i.on(n, function(e) {
                i.unbind(n), r.removeClass("active animate-out"), t.children().css({
                    transform: "",
                    "-ms-transform": "",
                ...
                r.removeClass("active animate-out"), t.children().css({
                    transform: "",
                    "-ms-transform": "",
                    "-webkit-transition-duration": "",
                    "-moz-transition-duration": "",
    ...
    Foundation.libs = Foundation.libs || {}, Foundation.libs.orbit = {
        ...
        events: function(e) {
            var t = this, n = new s(this.S(e), this.S(e).data("orbit-init"));
            this.S(e).data(t.name + "-instance", n);
        },
        reflow: function() {
            var e = this;
